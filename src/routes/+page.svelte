...
<main class="min-h-screen py-8">
	...
	<Card class="max-w-4xl mx-auto mb-16 p-12 shadow-xl dark:shadow-gray-800/30" size="lg">
		<div class="space-y-6">
			<Heading tag="h1" class="text-5xl font-extrabold dark:text-white mb-6">Učitel prstové abecedy</Heading>
	...
	<div class="max-w-7xl mx-auto px-4 mb-16">
		...
		<div class="grid md:grid-cols-2 justify-items-center gap-8">
			<Card class="hover:shadow-lg transition-shadow duration-200 dark:bg-gray-800">
